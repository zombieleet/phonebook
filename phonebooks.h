...
enum STATE_E { JUSTLOADED = -1 , EDITED = 0 , CREATED , REMOVED , SAVED } PROGRAM_STATE = JUSTLOADED;
...
extern struct PHONEBOOK_t * createContact(struct PHONEBOOK_t * contact, char * firstName, char * lastName ,unsigned long * work,unsigned long * home);
extern struct PHONEBOOK_t * addContact(struct PHONEBOOK_t * phoneBook );
extern void listContacts(struct PHONEBOOK_t * contacts);
extern void searchByName(struct PHONEBOOK_t * contacts);
extern void searchByNumber(struct PHONEBOOK_t * contacts);
extern void removeContact(struct PHONEBOOK_t * contacts);
extern void saveContacts( struct PHONEBOOK_t * contacts );
extern struct PHONEBOOK_t * loadContacts( struct PHONEBOOK_t * contacts );
extern void editContacts(struct PHONEBOOK_t * contacts );
